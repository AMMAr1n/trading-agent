...
class TradingExecutor:
    ...
    async def execute_decision(
        ...
        # Ajustar monto según volumen — menor volumen = menor riesgo
        volume_ratio = 1.0
        try:
            # Intentar obtener ratio de volumen desde la señal
            volume_ratio = getattr(decision, 'volume_ratio', 1.0) or 1.0
        except Exception:
            pass

        if volume_ratio < 0.5:
            # Volumen muy bajo — usar solo 15% del capital operable
            ...
            # Volumen bajo — usar solo 20% del capital operable
